...
module top (
  ...
  input  wire       sda_1_i,
  output wire       sda_1_o,
  output wire       sda_1_oe,

  output wire       scl_2_o,
  input  wire       sda_2_i,
  output wire       sda_2_o,
  output wire       sda_2_oe,
  ...
  // --- I2C BUS 1 (ADC 1) ---
    ...
    assign sda_1_o  = sdaOut_1;
    assign sda_1_oe = isSending_1 & ~sdaOut_1;
    assign sdaIn_1  = sda_1_i ? 1'b1 : 1'b0;
    ...
    assign sda_2_o  = sdaOut_2;
    assign sda_2_oe = isSending_2 & ~sdaOut_2;
    assign sdaIn_2  = sda_2_i ? 1'b1 : 1'b0;
